window.spb = function(modules) {
                ...
                function immediateFlush() {
                    return promise_ZalgoPromise.try((function() {
                        if (dom_isBrowser() && "file:" !== window.location.protocol && (events.length || tracking.length)) {
                            ...
                            events = [];
                            tracking = [];
                            return res.then(belter_src_util_noop);
                        }
                    }));
                }
    ...
    function eligibility_getNativeEligibility(_ref2) {
    ...
    var checkoutOpen = !1;
    var checkout_checkout_init = function initCheckout(_ref8) {
    ...
    var native_native_isEligible = function(_ref3) {
        ...
        var getNativeUrlForAndroid = util_memoize((function(_temp) {
        ...
        var getNativeUrl = util_memoize((function(_ref8) {
        ...
        var getNativePopupUrl = util_memoize((function(_ref9) {
        ...
        var getWebCheckoutUrl = util_memoize((function(_ref10) {
        ...
        var connectNative = util_memoize((function(_ref14) {
                    ...
                    if (native_native_isEligible({
                        ...
                        !function(_ref) {
                            ...
                            logger.addTrackingBuilder((function() {
                                ...
                                _ref2.button_version = "2.1.102", _ref2.button_correlation_id = buttonCorrelationID, 
                                _ref2;
                            }));
                            (function() {
                        ...
                        return function(_ref5) {
                            ...
                            return promise_ZalgoPromise.try((function() {
                                ...
                                return promise_ZalgoPromise.all([ eligibility_getNativeEligibility({
                                    vault: vault,
                                    platform: platform,
                                    shippingCallbackEnabled: shippingCallbackEnabled,
                    ...
                    var instanceProps = _extends({}, props, {
                        ...
                        onApprove: function(_ref8) {
                            ...
                            return supplementalDataPromise.then((function(_ref9) {
                                var orderID = _ref9.orderID, paymentID = _ref9.paymentID, intent = _ref9.intent, returnUrl = _ref9.returnUrl;
                                var urlParams = {};
